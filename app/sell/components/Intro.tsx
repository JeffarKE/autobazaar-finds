  ...
  return (
    <section className="rounded-2xl border border-green-200 bg-green-50 p-6">
      ...
      <p className="mt-3 leading-relaxed text-gray-700">
        Fill in a few details below and our team will review your
        submission before listing it on Auto Baazar Finds.
      </p>
      ...
      <div className="mt-6 flex items-start gap-3 rounded-xl border border-green-200 bg-white p-4">
        ...
        <p className="text-sm leading-relaxed text-gray-700">
          ...
          This helps us maintain a trusted marketplace with quality vehicle
          listings and protects buyers from misleading adverts.
        </p>
      </div>
    </section>
  );
